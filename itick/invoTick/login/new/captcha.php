<?php
    ...
    if (!isset($_SESSION['domain'])){echo 'x'; exit;}	
	$strings = '123456789';
	$i = 0; $characters = 5; $code = '';
	while ($i < $characters){ 
	...
	$font = 'ComicRelief-Bold';

	//draw text:
	imagettftext($im, 28, 0, 9, 28, $shadow, $font, $code);
	imagettftext($im, 28, 0, 2, 32, $foreground, $font, $code);     
